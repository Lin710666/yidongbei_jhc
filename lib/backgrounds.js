...
const PROCEDURAL = [
  {
    // 西湖美景：本项目的**默认背景**。画的是西湖意象（远山三层、雷峰塔剪影、
    // 断桥、柳枝、水面波光与薄雾），绘制逻辑在 public/js/lake.js 里 ——
    // 它和「西湖船娘」形象是同一条主题线上的东西，放一起才不会漂移。
    // 排在最前面是为了在背景选择器里第一眼就能看到它。
    id: 'proc-lake',
    kind: 'procedural',
    label: '西湖美景',
    note: '程序化绘制的西湖动态画面：远山、雷峰塔、断桥、柳枝与水面波光。完全离线，不需要任何素材',
    renderer: 'lake',
    palette: ['#3f6f86', '#2f6d6a', '#d9b06a'],
    tone: 'dark',
  },
  {
    id: 'proc-aurora',
