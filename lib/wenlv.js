...
const WORD_CLOUD = [
  ...
  { word: '游玩天数', weight: 64, action: 'days-stepper', role: 'core', group: '行程', hint: '点两侧的 ▼▲ 调天数' },
  ...
  { word: '预算', weight: 62, action: 'focus-group', payload: { group: '预算' }, group: '预算', role: 'label', hint: '点击展开「预算」这一组' },
  { word: '文案风格', weight: 60, action: 'focus-group', payload: { group: '文案风格' }, group: '文案风格', role: 'label', hint: '点击展开「文案风格」这一组' },
  { word: '饮食禁忌', weight: 56, action: 'focus-group', payload: { group: '饮食禁忌' }, group: '饮食禁忌', role: 'label', hint: '点击展开「饮食禁忌」这一组' },
  { word: '形象', weight: 54, action: 'focus-group', payload: { group: '形象' }, group: '形象', role: 'label', hint: '点击展开「形象」这一组' },
];
