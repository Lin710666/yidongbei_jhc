...
const BUILTIN_CARDS = [
  {
    ...
    model: { chat: null, temperature: 0.7, numCtx: 8192, numPredict: 1024 },
  ...
  },
  {
    ...
    model: { chat: null, temperature: 0.85, numCtx: 8192, numPredict: 2048 },
    live2d: { model: 'nahida', scale: 1, x: 0, y: 0, expression: '', idleMotion: true },
  ...
  function normalize(input, base = {}) {
    ...
    return {
      ...
      model: {
        ...
        numCtx: +(c.model && c.model.numCtx) || 8192,
