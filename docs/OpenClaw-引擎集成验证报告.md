...
```bash
$ openclaw skills install "C:\Users\<用户名>\Desktop\移动杯项目\yidongbei-2.2\.agents\skills\wenlv-assistant"
Installing to C:\Users\<用户名>\.openclaw\workspace\skills\wenlv-assistant…
Installed wenlv-assistant from path -> C:\Users\<用户名>\.openclaw\workspace\skills\wenlv-assistant
```
